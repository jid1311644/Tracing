	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getSource().equals(titleBar.getJlMinFrame())) {
			...
			if(name.equals("") || psw.equals("")) {
				...
				Message m = new WebServer(WebServer.LOGIN, new Message(
						name + "&,&" + psw)).sendResponseMsg();
				switch (m.getResponseMsgType()) {
				case Message.OK:
					JOptionPane.showMessageDialog(this,
							m.getResponseMsg(), "", JOptionPane.INFORMATION_MESSAGE);
					MainGUI.currentUser = name;
					new MainGUI().setVisible(true);
					this.dispose();
					break;
				case Message.ERROR:
					JOptionPane.showMessageDialog(this,
							m.getResponseMsg(), "", JOptionPane.ERROR_MESSAGE);
					break;
				case Message.WARNING:
					JOptionPane.showMessageDialog(this,
							m.getResponseMsg(), "", JOptionPane.WARNING_MESSAGE);
					break;
				default:
					break;
				}
			...
			if(name.equals("") || psw.equals("")) {
				...
				Message m = new WebServer(WebServer.SIGNIN, new Message(
						name + "&,&" + psw)).sendResponseMsg();
				switch (m.getResponseMsgType()) {
				case Message.OK:
					JOptionPane.showMessageDialog(this,
